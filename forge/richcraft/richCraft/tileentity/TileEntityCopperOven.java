...
public class TileEntityCopperOven extends TileEntity implements ISidedInventory {
	...
	public String getInventoryName() {
		return this.hasCustomInventoryName() ? this.localizedName : "container.copperOven";
	...
	public boolean isUseableByPlayer(EntityPlayer entityplayer) {
		return this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord) != this ? false : entityplayer.getDistanceSq(
	...
	public void updateEntity() {
		...
		if (this.worldObj.isRemote) {
			if (this.burnTime == 0 && this.canSmelt()) {
				this.currentItemsBurnTime = this.burnTime = getItemBurnTime(this.slots[1]);
	...
	public int getBurnTimeRemaainingScaled(int i) {
		if (this.currentItemsBurnTime == 0) {
			this.currentItemsBurnTime = this.furnaceSpeed;
		}
		return this.burnTime * i / this.currentItemsBurnTime;
	}

	public int getCookedProgressScaled(int i) {
