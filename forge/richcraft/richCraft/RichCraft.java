...
import richCraft.handles.GuiHandler;
...
public class RichCraft {
	...
	@Instance(modid)
	public static RichCraft instance;
	...
	public static final int GuiIDCopperOven = 0;
	...
	public void PreInit(FMLPreInitializationEvent preEvent) {
		...
		//Machines
		blockCopperOvenIdle = new CopperOven(false).setBlockName("CopperOvenIdle").setCreativeTab(richCraftTab);
		GameRegistry.registerBlock(blockCopperOvenIdle, "CopperOvenIdle");
		blockCopperOvenActive = new CopperOven(true).setBlockName("CopperOvenActive").setLightLevel(0.625F);
		GameRegistry.registerBlock(blockCopperOvenActive, "CopperOvenActive");
	...
	public void Init(FMLInitializationEvent event) {
		...
		GameRegistry.registerTileEntity(TileEntityCopperOven.class, "CopperOven");
