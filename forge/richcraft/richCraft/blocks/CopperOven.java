...
public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
	...
	public static void updateCopperOvenBlockState(boolean active, World worldObj,
		...
		if(active) {
			worldObj.setBlock(xCoord, yCoord, zCoord, RichCraft.blockCopperOvenActive);
		}else{
			worldObj.setBlock(xCoord, yCoord, zCoord, RichCraft.blockCopperOvenIdle);
		}
